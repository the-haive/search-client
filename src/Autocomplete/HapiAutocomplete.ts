...
import { autocomplete } from '../Common/Hapi/Typings/autocomplete';
 ...
 */
export class HapiAutocomplete extends BaseCall<string[]> implements Autocomplete {
    ...
    public fetch(
        ...
        if (this.cbRequest(suppressCallbacks, url, reqInit)) {
            return this.client.autocomplete(query.queryText, query.maxSuggestions, 1).then((data: autocomplete) => {
                        return data.index.autocomplete;
                })
