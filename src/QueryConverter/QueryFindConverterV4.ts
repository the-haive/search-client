...
import { QueryCategorizeConverterV4 } from './';

/**
 * Class to handle creating find lookups for restservice version 4.
 */
export class QueryFindConverterV4 extends QueryCategorizeConverterV4 {
